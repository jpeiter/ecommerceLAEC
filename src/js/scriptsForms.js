...
function formsValidations() {
    ...
    $("#form-cadastro").validate({
        ...
        messages: {
            ...
            dataNascimento: {
                required: 'A data de nascimento é de preenchimento obrigatório'
            },
            telefone: {
            ...
            rua: {
                required: 'Qual a sua rua?'
            },
            numero: {
                required: 'Qual o número de onde você mora?'
            },
            bairro: {
                required: 'Qual seu bairro?'
            },
            cidade: {
                required: 'Qual sua cidade?'
            },
            cep: {
                required: 'Qual seu CEP?'
            },
        },
        errorClass: 'error-message col-lg-12',
        errorElement: 'label'
