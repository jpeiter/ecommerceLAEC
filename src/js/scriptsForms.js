...
function formsValidations() {
    $("#form-login").validate({
        ...
        messages: {
            emailLogin: { required: 'O campo e-mail é de preenchimento obrigatório.', email: 'Informe um e-mail válido.' },
    ...
    $("#form-cadastro").validate({
        ...
        messages: {
            apelido: { required: 'O apelido é de preenchimento obrigatório.', minlength: 'Digite no mínimo dois caracteres.' },
            nomeCompleto: { required: 'O nome completo é de preenchimento obrigatório.', minlength: 'Digite no mínimo seis caracteres.' },
